...
class MageWorx_CustomerCredit_Model_Observer
{
    ...
    public function saveCustomerAfter(Varien_Event_Observer $observer) {
        ...
        $customer = $observer->getEvent()->getCustomer();
        /* @var $customerCredit MageWorx_CustomerCredit_Model_Credit */
        ...
        $customerCredit->update($data['value_change'], $data['comment']);
    ...
    */
    ...
    public function checkCompleteStatusOrder(Varien_Event_Observer $observer) {
        ...
        if ($order->getStatus() == 'complete') {
            Mage::getModel('mageworx_customercredit/credit', $customer)->processCreditProductPurchase($order);
    ...
    public function toHtmlBlockBefore(Varien_Event_Observer $observer) {
        ...
        if ($blockName == 'customer_account_navigation') {
            if (Mage::helper('mageworx_customercredit')->isShowCustomerCredit()) $block->addLink('customercredit', 'customercredit', Mage::helper('mageworx_customercredit')->__('My Credit'),array("_secure"=>true));
        } 
    }
