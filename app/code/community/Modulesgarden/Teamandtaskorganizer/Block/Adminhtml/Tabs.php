...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		...
		$this->addTab('tasks_list', array(
			...
			'content' => $layout->createBlock('teamandtaskorganizer/adminhtml_tasks')->toHtml(),
		));
		...
		if ($this->_canViewStatistics()){
			$this->addTab('statistics', array(
				...
				'content' =>
					$layout->createBlock('teamandtaskorganizer/adminhtml_statistics_stats')->toHtml().
					$layout->createBlock('teamandtaskorganizer/adminhtml_tasks')->toHtml()
			));
		}

		$this->addTab('settings', array(
			'label' => Mage::helper('teamandtaskorganizer')->__('Settings'),
			'content' => $layout->createBlock('teamandtaskorganizer/adminhtml_settings_edit')->toHtml(),
		));
