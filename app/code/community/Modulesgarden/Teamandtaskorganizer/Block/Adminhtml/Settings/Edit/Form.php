...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Settings_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		$form->setAction($this->getUrl('*/adminhtml_settings/save'))
				->setMethod('post');
