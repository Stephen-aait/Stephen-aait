 ...
 */
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Teamandtaskorganizer_Widget
        extends Mage_Adminhtml_Block_Template
{

    protected function _toHtml()
    {
        if (!Mage::getSingleton('admin/session')->isAllowed('teamandtaskorganizer/teamandtaskorganizer_tasks'))
            return '';
