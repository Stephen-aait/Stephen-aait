 ...
 */
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Teamandtaskorganizer_Tasks_Comments_Edit
        extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $taskId = $this->getRequest()->getParam('task_id') != null ? $this->getRequest()->getParam('task_id') : $this->getRequest()->getParam('id');
        $this->_updateButton('save', 'label', Mage::helper('teamandtaskorganizer')->__('Save Comment'));
        $this->_updateButton('back', 'onclick', "setLocation('" . $this->getUrl('*/teamandtaskorganizer_tasks/edittask', array('id' => $taskId,
        ...
        $this->_updateButton('delete', 'onclick', "deleteConfirm('" . Mage::helper('teamandtaskorganizer')->__('Are you sure you want to do this?') . "', '"
                . $this->getUrl('*/*/deleteComment', array('id' => $comment->getId())) . "')");
