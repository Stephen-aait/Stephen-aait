...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Tasks_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareColumns() {
		...
		$this->addColumn('id', array(
			...
			'width' => '50px',
			'index' => 'id',
                        'renderer'=> 'Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Template_Grid_Renderer_Unreaded',
		));
		...
		$this->addColumn('foreignitem', array(
			...
			'align' => 'left',
			'width' => '120px',
			'renderer' => 'Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Template_Grid_Renderer_Foreigntaskitem',
			'filter' => false,
		));
		...
		$this->addColumn('progress', array(
			...
			'width' => '150px',
			'index' => 'progress',
			'renderer' => 'Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Template_Grid_Renderer_Progress',
			'filter' => false,
		));
		...
		$this->addColumn('action', array(
			...
			'width' => '170',
			'type' => 'action',
			'renderer' => 'Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Template_Grid_Renderer_Action',
			'getter' => 'getId',
			'gridType' => 'task_list',
			'actions' => array(
				'view' => array(
					'caption' => Mage::helper('teamandtaskorganizer')->__('View'),
					'url' => array('base' => '*/adminhtml_task/viewtask'),
					'class' => 'ajax-link',
					'field' => 'id'
				),
				'edit' => array(
					'caption' => Mage::helper('teamandtaskorganizer')->__('Edit'),
					'url' => array('base' => '*/adminhtml_task/edittask'),
					'class' => 'ajax-link',
					'field' => 'id'
				),
				'delete' => array(
...
//		return $this;
	...
	public function getRowUrl($row) {
		...
		return $this->getUrl('*/*/edittask', array('id' => $row->getId()));
	}
