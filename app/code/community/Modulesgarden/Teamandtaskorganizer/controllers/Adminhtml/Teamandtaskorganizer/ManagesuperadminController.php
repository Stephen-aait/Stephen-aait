 ...
 */
class Modulesgarden_Teamandtaskorganizer_Adminhtml_Teamandtaskorganizer_ManagesuperadminController
        extends Modulesgarden_Teamandtaskorganizer_Controller_Action
{
     ...
     *
     * @return \Modulesgarden_Teamandtaskorganizer_Adminhtml_Teamandtaskorganizer_ManagesuperadminController
     */
    ...
    public function indexAction()
    {
        ...
        if (!$user->isAllowed('ASSIGN_PRIVILEGES') && count($seeOther) < 1) {
            ...
            return $this->_redirect('*/teamandtaskorganizer_tasks/index');
        }
...
//	}
    ...
    public function edittaskAction()
    {
        ...
        return $this->_forward('edittask', 'teamandtaskorganizer_tasks', 'adminhtml');
    }

    public function newAction()
    {
        Mage::register('tto_back_to_managesuperadmin', 1);
        return $this->_forward('new', 'teamandtaskorganizer_tasks', 'adminhtml');
    }
...
//	}
    ...
    {
        return $this->_forward('editcomment', 'teamandtaskorganizer_tasks', 'adminhtml');
    }
    ...
    {
        return $this->_forward('saveComment', 'teamandtaskorganizer_tasks', 'adminhtml');
    }
    ...
    public function saveautotaskAction()
    {
        ...
        if ($autoTask->getId()) {
            return $this->_redirect('adminhtml/teamandtaskorganizer_managesuperadmin/index', array(
...
//					}
    ...
    {
        return $this->_redirect('adminhtml/teamandtaskorganizer_managesuperadmin/index', array('tab' => 'teamandtaskorganizer_managesuperadmin_tabs_user_privileges'));
    }

    public function rautotasksAction()
    {
        return $this->_redirect('adminhtml/teamandtaskorganizer_managesuperadmin/index', array('tab' => 'teamandtaskorganizer_managesuperadmin_tabs_auto_tasks'));
    }

    public function rstatsAction()
    {
        return $this->_redirect('adminhtml/teamandtaskorganizer_managesuperadmin/index', array('tab' => 'teamandtaskorganizer_managesuperadmin_tabs_statistics'));
    }
