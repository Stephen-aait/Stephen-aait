<?php
class Netzkollektiv_InStorePickupPlus_Block_Onepage_Payment_Methods extends MageWorx_CustomerCredit_Block_Checkout_Onepage_Payment_Methods
{
    public function getMethods()
    {
        ...
        /**/
        //******************************************* Added Code From MageWorx_CustomerCredit Moduel **************************************        
        ...
        foreach ($origMethods as $method) {
            $code = $method->getCode();
            if ($code=='customercredit') { array_unshift($methods, $method); 
            } else { $methods[] = $method; 
            }
        }        
        //******************************************* Added Code From MageWorx_CustomerCredit Moduel **************************************   
