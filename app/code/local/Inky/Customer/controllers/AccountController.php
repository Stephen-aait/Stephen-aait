...
class Inky_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    {
		//================ if Redirected through Designs to login Page then continue with the given URL =================START==============
		
		if ( isset($_SESSION['previous_url']) ){
			$this->_redirectUrl($_SESSION['previous_url']);
			unset($_SESSION['previous_url']);
			return;
		}	
		
		//================ if Redirected through Designs to login Page then continue with the given URL =================END================
