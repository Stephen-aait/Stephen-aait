...
class Inky_Designersoftware_Block_Adminhtml_Designersoftware_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $getCategory = Mage::helper('designersoftware/category')->getAllCategorys();
      ...
      $fieldset->addField('remove_status', 'select', array(
          'label'     => Mage::helper('designersoftware')->__('Remove Status'),
          'name'      => 'remove_status',
          'values'    => array(
			  array(
                  'value'     => 2,
