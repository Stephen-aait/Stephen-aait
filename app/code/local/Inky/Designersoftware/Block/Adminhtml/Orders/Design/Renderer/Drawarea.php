<?php
class Inky_Designersoftware_Block_Adminhtml_Orders_Design_Renderer_Drawarea extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {

    public function render(Varien_Object $row) {
        $data = $row->getData();       
        
        //echo '<pre>';print_r($data);exit;
        $params = 'designCode/'.$data['style_design_code'].'/storeId/1/orderId/'. $data['order_id'];
