<?php
class A2bizz_Customerdesign_Block_Adminhtml_Customer_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $imageHtml='<a href="' . $this->getUrl('designersoftware/adminhtml_designersoftware/edit', array('id' => $row->getId())) . '">Edit</a><br>';
