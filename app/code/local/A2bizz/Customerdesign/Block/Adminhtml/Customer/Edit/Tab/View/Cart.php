 ...
 */
class A2bizz_Customerdesign_Block_Adminhtml_Customer_Edit_Tab_View_Cart extends Mage_Adminhtml_Block_Customer_Edit_Tab_View_Cart
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('product_id', array(
            ...
            'header' => Mage::helper('customer')->__('Design PDF'),
            'index' => 'content',
            'renderer'  => 'A2bizz_Customerdesign_Block_Adminhtml_Customer_Renderer_Drawarea',
        ));
    ...
    {
        return 'javascript:void(0);';//$this->getUrl('*/catalog_product/edit', array('id' => $row->getProductId()));
    }
