 ...
 */
class Webtex_Giftcards_Block_Adminhtml_Promo_Quote_Edit_Tab_Actions
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('is_use_giftcard', 'select', array(
            'label'     => Mage::helper('salesrule')->__('Use Gift Card'),
            'title'     => Mage::helper('salesrule')->__('Use Gift Card'),
            'name'      => 'is_use_giftcard',
            'options'    => array(
