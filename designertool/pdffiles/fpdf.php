...
*                                                                              *
*******************************************************************************/
function FPDF($orientation='L', $unit='pt', $format='A4')
{
	//Some checks
	$this->_dochecks();
	...
	$this->CoreFonts=array('courier'=>'Courier', 'courierB'=>'Courier-Bold', 'courierI'=>'Courier-Oblique', 'courierBI'=>'Courier-BoldOblique',
		...
		'symbol'=>'Symbol', 'zapfdingbats'=>'ZapfDingbats','hanwangkantan'=>'hanwangkantan','font_chinese'=>'font_chinese');
	//Scale factor
	if($unit=='pt')
		$this->k=1;
	elseif($unit=='mm')
