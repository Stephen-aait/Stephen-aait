...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Tasks_Comments_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _getCollectionClass(){
		return 'teamandtaskorganizer/task_comment_collection';
	}
		...
		$this->addColumn('action', array(
			...
			'actions' => array(
				'edit' => array(
					...
					'url' => array('base' => '*/adminhtml_task/editcomment'),
					'field' => 'id'
				),
				'delete' => array(
