...
class Sparx_Designersoftware_Block_Adminhtml_Parts_Type_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('parts_typeGrid');
      $this->setDefaultSort('parts_type_id');
  ...
  {
      $this->addColumn('parts_type_id', array(
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('designersoftware')->__('Name'),
          'align'     =>'left',
          'index'     => 'title',
      ));
    ...
    {
        $this->setMassactionIdField('parts_type_id');
