 ...
 */
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Teamandtaskorganizer_Tasks_Comments_Edit_Form
        extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setAction($this->getUrl('*/teamandtaskorganizer_tasks/saveComment'))
                ->setMethod('post');
