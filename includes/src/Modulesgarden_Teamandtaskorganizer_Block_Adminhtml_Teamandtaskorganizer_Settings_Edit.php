 ...
 */
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Teamandtaskorganizer_Settings_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
	...
	public function __construct() {
		...
		$this->_controller = 'adminhtml_teamandtaskorganizer_settings';
		...
		$this->_updateButton('save', 'onclick', 'settings_form.submit()');
