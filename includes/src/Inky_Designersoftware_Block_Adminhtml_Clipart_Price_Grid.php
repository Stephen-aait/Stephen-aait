...
class Inky_Designersoftware_Block_Adminhtml_Clipart_Price_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  /*$this->addColumn('sort_order', array(
          ...
          'width'     => '80px',
          'index'     => 'sort_order',
          'renderer'  => 'Inky_Designersoftware_Block_Adminhtml_Clipart_Price_Renderer_Sort',
      ));*/
