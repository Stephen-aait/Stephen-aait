 ...
 */
class Wyomind_Estimateddeliverydate_Block_Adminhtml_Catalog_Product_Edit_Tab_Customoptions_Option extends MageWorx_Adminhtml_Block_Customoptions_Adminhtml_Catalog_Product_Edit_Tab_Options_Option {
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild('copy_option_button', $this->getLayout()->createBlock('adminhtml/widget_button')
                        ->setData(array(
