...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Tasks_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		$this->addTab('edit_tasks', array(
			...
			'content' => $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_tasks_edit')->toHtml(),
		));
		
		$this->addTab('task_comments', array(
			'label' => Mage::helper('teamandtaskorganizer')->__('Comments'),
			'content' => $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_tasks_comments')->toHtml(),
		));
