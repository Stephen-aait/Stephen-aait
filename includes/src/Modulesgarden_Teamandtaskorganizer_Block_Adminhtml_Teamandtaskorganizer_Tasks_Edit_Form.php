 ...
 */
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Teamandtaskorganizer_Tasks_Edit_Form
        extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        if (Mage::app()->getRequest()->isAjax()) {
            ...
            $reload = $parent == 'taskslist' ? 1 : 0;
            $postURL = $reload == 1 ? Mage::helper('adminhtml')->getUrl("adminhtml/teamandtaskorganizer_tasks/save", array('parent' => 'taskslist')) :
                    Mage::helper('adminhtml')->getUrl("adminhtml/teamandtaskorganizer_tasks/save");
						...
						(function($){
							$(document).ready(function(){
								$("#edit_task_ajax_form_submit").click(function(){
									...
									$.post("' . $postURL . '", values, function(response){
                                                                                tto.popup.close();
        ...
        if (Mage::registry('tto_back_to_managesuperadmin')) {
            $fieldset->addField('back', 'hidden', array(
                'name' => 'back',
                'value' => "adminhtml/teamandtaskorganizer_managesuperadmin/index"
            ));
        }
