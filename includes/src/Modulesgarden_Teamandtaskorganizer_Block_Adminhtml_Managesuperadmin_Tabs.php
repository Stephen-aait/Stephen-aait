...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Managesuperadmin_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		...
		if ($user->isAllowed('SEE_OTHER_TASK')){
			$this->addTab('tasks_list', array(
				...
				'content' => $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_tasks')->toHtml(),
			));
		}
		...
		if ($user->isAllowed('ASSIGN_PRIVILEGES')){
			$this->addTab('user_privileges', array(
				...
				'content' => $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_managesuperadmin_users')->toHtml(),
			));
		}
		...
		if ($user->isAllowed('ADD_AUTOTASK')){
			$this->addTab('auto_tasks', array(
				...
				'content' => $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_managesuperadmin_autotasks')->toHtml(),
			));
		}
