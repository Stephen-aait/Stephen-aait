...
class Modulesgarden_Teamandtaskorganizer_Block_Adminhtml_Support_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml(){
		...
		$this->addTab('open_ticket', array(
			...
			'content' => $layout->createBlock('teamandtaskorganizer/adminhtml_support_edit')->toHtml(),
		));
