 ...
 */
class Modulesgarden_Teamandtaskorganizer_Adminhtml_Teamandtaskorganizer_TasksController
        extends Modulesgarden_Teamandtaskorganizer_Controller_Action
{

    protected function _initAction()
    {
        $this->loadLayout()->_setActiveMenu('teamandtaskorganizer/teamandtaskorganizer_tasks');
        return $this;
    }

    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('teamandtaskorganizer/teamandtaskorganizer_tasks');
    }
    ...
    public function renderAjaxLayout()
    {
        ...
        if ($this->getRequest()->getActionName() == 'edittask') {
            $blocks->unsetChild('teamandtaskorganizer_adminhtml_teamandtaskorganizer_tasks_comment_grid');
        }
        echo $blocks->toHtml();
        exit;
    }
    ...
    public function indexAction()
    {
        ...
        $license_check = team_and_task_organizer_for_magento_license_1635();
if($license_check['status'] != 'Active'){
    ...
    public function newAction()
    {
        ...
        if ($this->getRequest()->isAjax()) {
            ...
            echo $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_teamandtaskorganizer_tasks_edit')->toHtml();
            die();
        }
        ...
        if (!$user->isAllowed('ADD_TASK')) {
            ...
            return $this->_redirect('adminhtml/teamandtaskorganizer_tasks/index');
        }
...
if($license_check['status'] != 'Active'){
    ...
    public function viewtaskAction()
    {
        ...
        echo $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_teamandtaskorganizer_tasks_view')->toHtml();
        die();
    }
...
if($license_check['status'] != 'Active'){
	...
	exit;
            ...
            if ($this->getRequest()->isAjax()) {
                ...
                if ($this->getRequest()->getParam('parent') == 'taskslist') {
    ...
    public function saveCommentAction()
    {
        ...
        if (!$isAjax) {
            $this->_redirect('adminhtml/teamandtaskorganizer_tasks/edittask', array(
                'id' => $taskId,
...
//
    ...
    {
        return $this->_redirect('adminhtml/teamandtaskorganizer_tasks/index', array('tab' => 'teamandtaskorganizer_tabs_statistics'));
    }

    public function rsettingsAction()
    {
        return $this->_redirect('adminhtml/teamandtaskorganizer_tasks/index', array('tab' => 'teamandtaskorganizer_tabs_settings'));
    }
    ...
    public function getCommentsAction()
    {
        ...
        try {
            ...
            $commentPreviewBlock = $this->getLayout()->createBlock('teamandtaskorganizer/adminhtml_teamandtaskorganizer_tasks_comments_preview');
