...
class Modulesgarden_Teamandtaskorganizer_Adminhtml_SettingsController extends Modulesgarden_Teamandtaskorganizer_Controller_Action {
	...
	public function saveAction(){
		...
		return $this->_redirect('teamandtaskorganizer/adminhtml_task/index', array(
