...
Product.Gallery.prototype = {
    ...
    handleUploadComplete: function(files) {
        files.each(function(item) {
            ...
            newImage.label = '';
            newImage.view = 1; // New Added Column 'View'
            newImage.position = this.getNextPosition();
            newImage.disabled = 0;
            newImage.removed = 0;
            //newImage.drawarea = ''; // New Added Column 'Draw Area'
    ...
    updateImage: function(file) {
        ...
        this.images[index].label = this.getFileElement(file,
                'cell-label input').value;
        this.images[index].position = this.getFileElement(file,
                'cell-position input').value;
        this.images[index].view = this.getFileElement(file,
                'cell-view select').value;		// New Added Column 'View'
        ...
        this.images[index].drawarea = this.getFileElement(file,
                'cell-drawarea button').value;		// New Added Column 'Draw Area'
//        alert(this.images[index].position);
    ...
    updateVisualisation: function(file) {
        ...
        this.getFileElement(file, 'cell-view select').value = image.view;
